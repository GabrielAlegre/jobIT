...
@Component({
    selector: 'empleados-mis-suscripciones',
    standalone: true,
    imports: [CommonModule],
    templateUrl: './mis-suscripciones.page.html',
    styleUrls: ['./mis-suscripciones.page.scss']
})
export default class MisSuscripcionesPage implements OnInit {
